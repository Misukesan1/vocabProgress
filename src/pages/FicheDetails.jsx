      ...
      <BoxContent>
        ...
        <div className="flex justify-center mx-3">
          <Button
              ...
              className="my-2"
              fullWidth
              onPress={() => {setFlashCardSelected(null); onOpen()}}
            >
              Créer une flashcard
            </Button>
        </div>
        ...
        {flashcards?.length > 0 ? flashcards?.map((flashcard) => (
          <FlashCard key={flashcard.id} flashcard={flashcard} onEdit={() => {setFlashCardSelected(flashcard); onOpen()}}/>
        )) : (
          <BoxContent>
        ...
        <ModalFlashcard isOpen={isOpen} onOpenChange={onOpenChange} flashcard={flashCardSelected} ficheId={Number(id)}/>
